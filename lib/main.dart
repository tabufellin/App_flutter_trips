...
class MyApp extends StatelessWidget {// StatelessWidget es la clase padre de los Widgets
  ...
  Widget build(BuildContext context) {
    return MaterialApp( // esto se pone para que ponga todos los elementos de materialDesign
      title: 'Flutter Demo',
      theme: ThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold( // estructura de  una aplicación, la grafica
                     // cada elemtno que miramos en pantalla
      appBar: AppBar(
